    ...
    <div className="fixed inset-0 z-[9999] flex items-start justify-center overflow-y-auto bg-slate-950/50 p-4 sm:items-center">
      <form className="my-6 w-full max-w-2xl rounded-2xl bg-white p-5 shadow-xl" onSubmit={submitInterviewRequest}>
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-4">
          ...
          <div className="rounded-xl border border-slate-200 p-3">
            <p className="field-label">Candidate ID</p>
            <p className="mt-1 truncate text-sm font-semibold text-slate-950">{candidate._id}</p>
          </div>
        </div>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <label>
              ...
              <input className="field-control" name="startDate" type="date" value={requestForm.startDate} onChange={updateRequestForm} required />
            </label>
            <label>
              <span className="field-label">End date</span>
              <input className="field-control" name="endDate" type="date" value={requestForm.endDate} onChange={updateRequestForm} required />
            </label>
          </div>
        </div>
